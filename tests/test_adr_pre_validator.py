...
class TestCheckRequiredSections:
    def test_all_sections_present(self, validator: ADRPreValidator) -> None:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "# ADR\n**Status:** Proposed\n## Context\nctx\n## Consequences\ncon\n",
                "missing_section_decision",
            ),
            (
                "# ADR\n**Status:** Proposed\n## Context\nctx\n## Decision\ndec\n",
                "missing_section_consequences",
            ),
        ],
    )
    def test_missing_section_detected(
        self, validator: ADRPreValidator, content: str, expected_code: str
    ) -> None:
        result = validator.validate(content)
        assert not result.passed
        codes = [i.code for i in result.issues]
    ...
    def test_missing_section_not_fixable(self, validator: ADRPreValidator) -> None:
        content = (
            "# ADR\n**Status:** Proposed\n## Decision\ndec\n## Consequences\ncon\n"
        )
        result = validator.validate(content)
...
class TestCheckEmptySections:
    @pytest.mark.parametrize(
        ...
        [
            (
                "# ADR\n**Status:** Proposed\n"
                "## Context\n\n## Decision\ndec\n## Consequences\ncon\n",
                "empty_section_context",
            ),
            (
                "# ADR\n**Status:** Proposed\n"
                "## Context\nctx\n## Decision\n\n## Consequences\ncon\n",
                "empty_section_decision",
            ),
            (
                "# ADR\n**Status:** Proposed\n"
                "## Context\nctx\n## Decision\ndec\n## Consequences\n\n",
                "empty_section_consequences",
            ),
        ],
    )
    ...
    def test_nonempty_sections_pass(self, validator: ADRPreValidator) -> None:
        result = validator.validate(_valid_adr())
        codes = [i.code for i in result.issues]
...
class TestCheckSupersession:
    def test_valid_supersession_passes(self, validator: ADRPreValidator) -> None:
    ...
    def test_invalid_supersession_detected(self, validator: ADRPreValidator) -> None:
    ...
    def test_no_supersession_reference_passes(self, validator: ADRPreValidator) -> None:
        result = validator.validate(_valid_adr())
        codes = [i.code for i in result.issues]
        assert "invalid_supersession" not in codes

    def test_superseding_variant_detected(self, validator: ADRPreValidator) -> None:
    ...
    def test_superseded_past_tense_detected(self, validator: ADRPreValidator) -> None:
    ...
    def test_supersession_with_null_adr_list_treated_as_empty(
    ...
    def test_missing_reciprocal_supersedes_detected(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_missing_reciprocal_superseded_by_detected(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_reciprocal_superseded_by_present_passes(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_superseded_by_nonexistent_adr_detected(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_proposed_cannot_supersede_accepted(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_proposed_cannot_supersede_deprecated(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_accepted_can_supersede_accepted(self, validator: ADRPreValidator) -> None:
    ...
    def test_accepted_superseded_by_proposed_flagged(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_duplicate_supersedes_ref_produces_single_issue(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_bidirectional_check_skipped_when_no_heading(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_proposed_can_supersede_proposed(self, validator: ADRPreValidator) -> None:
...
class TestCheckVolatileLineCitations:
    def test_no_line_citations_passes(self, validator: ADRPreValidator) -> None:
        content = _valid_adr(
    ...
    def test_multiple_line_citations_counted(self, validator: ADRPreValidator) -> None:
        content = _valid_adr(
            consequences=(
    ...
    def test_line_citation_is_fixable(self, validator: ADRPreValidator) -> None:
...
class TestCheckStaleAmendmentNotes:
    ...
    def test_stale_note_when_referenced_adr_accepted(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_two_stale_notes_produce_two_issues(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_case_insensitive_detection(self, validator: ADRPreValidator) -> None:
    ...
    def test_no_all_adrs_produces_no_issues(self, validator: ADRPreValidator) -> None:
    ...
    def test_duplicate_stale_notes_for_same_adr_deduplicated(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_referenced_adr_without_status_field_skipped(
        self, validator: ADRPreValidator
    ) -> None:
...
class TestCheckBareADRReferences:
    def test_bare_reference_detected(self, validator: ADRPreValidator) -> None:
    ...
    def test_bare_reference_is_fixable(self, validator: ADRPreValidator) -> None:
    ...
    def test_no_cross_references_passes(self, validator: ADRPreValidator) -> None:
...
class TestNonexistentADRReference:
    def test_nonexistent_reference_detected(self, validator: ADRPreValidator) -> None:
    ...
    def test_nonexistent_reference_not_fixable(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_existing_reference_not_flagged(self, validator: ADRPreValidator) -> None:
    ...
    def test_no_all_adrs_skips_existence_check(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_bare_nonexistent_ref_produces_both_issues(
        self, validator: ADRPreValidator
    ) -> None:
...
class TestMismatchedADRTitle:
    def test_wrong_title_detected(self, validator: ADRPreValidator) -> None:
    ...
    def test_no_all_adrs_skips_title_check(self, validator: ADRPreValidator) -> None:
    ...
    def test_nonexistent_ref_skips_title_check(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_emdash_with_double_dash_captures_trailing_prose_as_title(
        self, validator: ADRPreValidator
    ) -> None:
...
class TestCheckSourceFunctionRefs:
    ...
    def test_phantom_function_detected(
        self, validator: ADRPreValidator, tmp_path: Path
    ) -> None:
    ...
    def test_no_repo_root_skips_check(self, validator: ADRPreValidator) -> None:
    ...
    def test_phantom_symbol_is_not_fixable(
        self, validator: ADRPreValidator, tmp_path: Path
    ) -> None:
    ...
    def test_module_level_constant_flagged_as_phantom(
        self, validator: ADRPreValidator, tmp_path: Path
    ) -> None:
    ...
    def test_multiple_phantom_symbols_detected(
        self, validator: ADRPreValidator, tmp_path: Path
    ) -> None:
    ...
    def test_non_src_path_not_matched(self, validator: ADRPreValidator) -> None:
    ...
    def test_duplicate_references_produce_one_issue(
        self, validator: ADRPreValidator, tmp_path: Path
    ) -> None:
...
class TestCheckCrossReferenceTitles:
    ...
    def test_abbreviated_title_is_fixable(self, validator: ADRPreValidator) -> None:
    ...
    def test_unknown_number_ignored(self, validator: ADRPreValidator) -> None:
    ...
    def test_multiple_shared_numbers_exact_match(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_multiple_shared_numbers_abbreviated_flagged(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_no_all_adrs_skips_check(self, validator: ADRPreValidator) -> None:
...
class TestWordPrefixOverlap:
    ...
    def test_emdash_abbreviated_not_double_flagged(
        self, validator: ADRPreValidator
    ) -> None:
...
class TestDictCollisionSharedNumbers:
    ...
    def test_correct_title_with_shared_numbers_passes(
        self, validator: ADRPreValidator
    ) -> None:
    ...
    def test_last_entry_not_favored_in_dict(self, validator: ADRPreValidator) -> None:
    ...
    def test_abbreviated_title_not_double_flagged(
        self, validator: ADRPreValidator
    ) -> None:
...
class TestMultipleIssues:
    def test_multiple_issues_collected(self, validator: ADRPreValidator) -> None:
