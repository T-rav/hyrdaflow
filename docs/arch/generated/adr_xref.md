...
| `src.adversarial_labels` | ADR-0063 |
| `src.adversarial_retry_loop` | ADR-0063 |
| `src.agent` | ADR-0024, ADR-0027 |
| `src.agent_cli` | ADR-0004 |
| `src.assumption_surfacer` | ADR-0063 |
...
| `src.discovery_council` | ADR-0063 |
| `src.discovery_council_prompts` | ADR-0063 |
...
| `src.events` | ADR-0006, ADR-0055, ADR-0063 |
...
| `src.models` | ADR-0011, ADR-0012, ADR-0013, ADR-0014, ADR-0015, ADR-0016, ADR-0025, ADR-0031, ADR-0037, ADR-0045, ADR-0050, ADR-0063 |
| `src.orchestrator` | ADR-0006, ADR-0009, ADR-0014, ADR-0044, ADR-0045 |
| `src.path` | ADR-0032 |
| `src.pending_concerns` | ADR-0063 |
| `src.plan_council` | ADR-0063 |
| `src.plan_council_prompts` | ADR-0063 |
| `src.plan_phase` | ADR-0014, ADR-0031, ADR-0063 |
| `src.ports` | ADR-0003, ADR-0044 |
| `src.post_merge_handler` | ADR-0012, ADR-0014, ADR-0015, ADR-0016, ADR-0019, ADR-0063 |
...
| `src.shape_challenger` | ADR-0063 |
| `src.shape_expert_council` | ADR-0063 |
| `src.shape_phase` | ADR-0031, ADR-0045, ADR-0063 |
| `src.shape_runner` | ADR-0031, ADR-0045 |
| `src.skill_prompt_eval_loop` | ADR-0045 |
| `src.spec_ac_generator` | ADR-0063 |
| `src.spec_judge` | ADR-0063 |
