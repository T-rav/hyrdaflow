...
- Source issue: #2341
- Supersedes: [ADR-0023 Gate Triage Call on Config Toggle, Not Just HITL Fallback](0023-gate-triage-call-not-hitl-fallback.md)
- Related: [ADR-0023 Stats Counter Placement in Delegating Helpers](0023-stats-counter-placement-in-delegating-helpers.md) — covers the extracted rule that stats counters must be placed inside the helper's branching logic, not at the call site
