# ADR-0039: Stats Counter Placement When Delegating to Conditional Helpers
...
- [ADR-0034 (Auto-Triage Toggle Must Gate Routing, Not Just Stat Tracking)](0034-auto-triage-toggle-must-gate-routing.md) — canonical ADR whose Rule 4 already covers this counter-placement principle
