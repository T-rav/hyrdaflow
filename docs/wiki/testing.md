...
```json:entry
{"id":"01KQ11NX7HJCH34WSSAFMB0PB9","title":"Tech stack","content":"- **Python 3.11** with Pydantic, asyncio\n- **FastAPI + WebSocket** for dashboard\n- **React + Vite** for dashboard UI\n- **Ruff** for linting and formatting\n- **Pyright** for type checking\n- **Bandit** for security scanning\n- **pytest + pytest-asyncio + pytest-xdist** for testing\n- **uv** for dependency management","topic":"architecture","source_type":"manual","source_issue":null,"source_repo":null,"created_at":"2026-04-25T00:47:19.793054+00:00","updated_at":"2026-04-25T00:47:19.793055+00:00","valid_from":"2026-04-25T00:47:19.793054+00:00","valid_to":null,"superseded_by":null,"superseded_reason":null,"confidence":"medium","stale":false,"corroborations":1}
```
...
```json:entry
{"id":"01KQ11NX7HJCH34WSSAFMB0PBT","title":"Tests","content":"```bash\nmake test           # Run unit tests (fail-fast)\nmake test-fast      # Quick test run (-x --tb=short)\nmake test-cov       # Run tests with coverage report (70% threshold)\nmake integration    # Run integration tests\nmake soak           # Run soak/load tests\n```","topic":"patterns","source_type":"manual","source_issue":null,"source_repo":null,"created_at":"2026-04-25T00:47:19.793448+00:00","updated_at":"2026-04-25T00:47:19.793449+00:00","valid_from":"2026-04-25T00:47:19.793448+00:00","valid_to":null,"superseded_by":null,"superseded_reason":null,"confidence":"medium","stale":false,"corroborations":1}
```
...
```json:entry
{"id":"01KQ11NX7HJCH34WSSAFMB0PBV","title":"Quality","content":"```bash\nmake lint           # Auto-fix linting\nmake lint-check     # Check linting (no fix)\nmake typecheck      # Run Pyright type checks\nmake security       # Run Bandit security scan\nmake quality        # Lint + typecheck + security + test (parallel)\nmake quality-lite   # Lint + typecheck + security (no tests)\n```","topic":"patterns","source_type":"manual","source_issue":null,"source_repo":null,"created_at":"2026-04-25T00:47:19.793453+00:00","updated_at":"2026-04-25T00:47:19.793454+00:00","valid_from":"2026-04-25T00:47:19.793453+00:00","valid_to":null,"superseded_by":null,"superseded_reason":null,"confidence":"medium","stale":false,"corroborations":1}
```
