...
export const BACKGROUND_WORKERS = [
  ...
  { key: 'memory_backlog', label: 'Memory Backlog', description: 'Files hydraflow-find issues for pending entries in docs/wiki/memory-feedback/.', color: theme.accent, group: 'caretaking', tags: ['quality'] },
