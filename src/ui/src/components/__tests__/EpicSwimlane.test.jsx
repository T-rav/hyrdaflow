...
describe('EpicSwimlane', () => {
  it('renders the swimlane container', () => {
    render(<EpicSwimlane>{mockChildren}</EpicSwimlane>)
  ...
  it('shows empty state when children is empty', () => {
    render(<EpicSwimlane>{[]}</EpicSwimlane>)
    expect(screen.getByTestId('swimlane-empty')).toBeInTheDocument()
    expect(screen.getByText('No sub-issues')).toBeInTheDocument()
  })

  it('shows empty state when children is null', () => {
    render(<EpicSwimlane>{null}</EpicSwimlane>)
    expect(screen.getByTestId('swimlane-empty')).toBeInTheDocument()
  })
})
