...
class HydraFlowConfig(BaseModel):
    ...
    max_discussion_comment_chars: int = Field(
        ...
        ge=100,
        le=10_000,
        description="Max characters per discussion comment in agent prompts",
    )
    max_common_feedback_chars: int = Field(
        default=2_000,
        ge=500,
        le=20_000,
        description="Max characters for common review feedback in agent prompts",
    )
    ...
    max_review_feedback_chars: int = Field(
        ...
        ge=500,
        le=20_000,
        description="Max characters for review feedback in agent prompts",
    )
    ...
    max_planner_line_chars: int = Field(
        ...
        ge=100,
        le=5_000,
        description="Max characters per line in planner prompts before truncation",
    )
    ...
    max_unsticker_cause_chars: int = Field(
        ...
        ge=500,
        le=20_000,
        description="Max characters for PR unsticker escalation cause in prompts",
    )
