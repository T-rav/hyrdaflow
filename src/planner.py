...
class PlannerRunner(BaseRunner):
    ...
    @property
    def _max_comment_chars(self) -> int:
        return self._config.max_planner_comment_chars

    @property
    def _max_line_chars(self) -> int:
        return self._config.max_planner_line_chars
    ...
    def _build_retry_prompt(
        ...
        *,
        ...
        compact_failed_plan = self._truncate_text(
            failed_plan, self._config.max_failed_plan_chars, self._max_line_chars
        )
