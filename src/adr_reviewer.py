...
minority_note: <dissenting opinion if not unanimous, or "none">"""
    ...
    async def _route_pre_validation_failure(
        ...
        """Route a pre-validation failure to triage (or HITL as fallback)."""
    ...
    async def _execute_triage_or_hitl(
        ...
        *,
        ...
        When auto_triage is enabled: always try triage first.
        When auto_triage is disabled: try triage first, fall back to HITL.
